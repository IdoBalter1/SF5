...
network_configs = {
    ...
    'Poisson (k = 20)': {'creator': lambda: Network.from_poisson(20,10000), 'color_original': 'purple'},
...
for network_name, net_config_details in network_configs.items():
    ...
    save_filename = f"NEWNcluster_analysis_{safe_network_name}_vs_lambda_multi_std3.svg"
