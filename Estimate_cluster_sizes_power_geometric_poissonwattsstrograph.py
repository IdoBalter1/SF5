...
std_high_high_conf = np.linspace(350,10500,200) 
...
lambda_values = [0.2,0.4,0.7,1]# Using 100 lambda values
...
for lam in lambda_values:
    ...
    for network_type, network_template in network_configs.items():
        ...
        for std in std_values: # This loop currently runs only once as std_values = [7]
            ...
            if (network_type == 'geometric' and std > 7.5) or network_type =='poisson': 
    ...
    plt.savefig(f"plot_all_networks_lambda_{lam:.3f}.png")
