...
std_high_high = np.linspace(350,10500,250) 
...
num_avg_runs_infection_length = 1 
...
if __name__ == "__main__":
    ...
    for current_lam_val in lambda_values_to_process:
        ...
        fig.suptitle(f'Infection Period Analysis (λ={lambda_values_to_process:.2f}) for {num_initial_to_infect_config} initial {infection_word}', fontsize=16)
        plt.tight_layout()
        filename = f"Infection_period_analysis_lambda_{current_lam_val:.2f}_1infection0_2.png" # Use current lambda in filename
