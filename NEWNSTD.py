...
std_values_to_process = np.array([50,110,400, 750, 10000])
...
network_configs = {
    ...
    'Power Law (α=1.1)': {'creator': lambda: Network.from_geometric(1/21, 10000), 'color_original': 'purple'},
...
num_avg_runs_fds = 10 # Number of times to run estimate_outbreak_disjointset_from_network for averaging
...
for network_name, net_config_details in network_configs.items():
    ...
    save_filename = f"HHHKNEWNcluster_analysis_{safe_network_name}_vs_lambda_multi_std1.svg"
