...
std_high_high_conf = np.linspace(6100,15000,50)
...
if __name__ == "__main__":
    ...
    lambda_values_to_process = [0.4,1]
    for current_lam_val in lambda_values_to_process:
        ...
        plt.tight_layout()
        filename = f"NEWNInfection_period_analysis_lambda_123{current_lam_val:.2f}_1infection0_2.svg" # Use current lambda in filename
